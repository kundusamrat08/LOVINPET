...
$sql = "SELECT * FROM trainer where Trainer_email='" . $email . "' and Trainer_password='" . $password . "'";
...
{   
    ...
    session_start();    
	$_SESSION['email'] = $row['Trainer_email'];
...
<body>
    ...
    <div class="container">
    <div class="heading">Trainer & Groomer Login</div>
    <form action="" class="form"  method="post">
      <input class="input" type="email" name="email" id="email" placeholder="Email" required>
      <input class="input" type="password" name="password" id="password" placeholder="Password" required>

      <input class="login-button" type="submit" name="submit" value="Login">
      <span class="forgot-password">Don't have an account? <a href="trainer_registration.php">Register</a></span>
    </form>   
    </div>
</body>
</html>
