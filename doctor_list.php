...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['doctor_id']) && isset($_POST['patient_name']) && isset($_POST['patient_email']) && isset($_POST['patient_phone']) && isset($_POST['card_number']) && isset($_POST['expiry_date']) && isset($_POST['cvv'])) {
        ...
        $query = "SELECT fees FROM doctor WHERE id = '$doctor_id'";
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            $query = "INSERT INTO doctor_booking (doctor_id, patient_name, patient_email, patient_phone, payment_amount, status, paid, card_number, expiry_date, cvv) 
            ...
            $doctorQuery = "SELECT * FROM doctor WHERE id = '$doctor_id'";
            ...
            if ($doctorResult && mysqli_num_rows($doctorResult) > 0) {
                ...
                $doctorEmail = $doctorInfo['Doctor_email'];
                $doctorNumber = $doctorInfo['Doctor_number'];
            } else {
                $doctorName = "N/A";
                $doctorEmail = "N/A";
                $doctorNumber = "N/A";
            ...
            $mail->Body = "Your Appointment has been successfully booked.<br><br>Doctor's Information:<br>Name: $doctorName<br>Email: $doctorEmail<br>Phone: $doctorNumber<br><br>Doctor will contact you soon.";
            ...
            echo "<div style='text-align: center;'><p><br><br><br><br><h1>Doctor's Appointment Booked Sucessfully,</h1><br>Check Your Mail!<br><a href='index.php'>Shop More!</a><br><br><br><br><br><br></p></div>";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <div class="doctor-card">
                ...
                <button class="book-appointment-btn" data-doctor-id="<?php echo $row['id']; ?>">Book Appointment</button>
            </div>
            <?php
        }
    } else {
...
<div id="bookingForm">
    ...
    <div id="dateSelectors">
        ...
        <!-- Display doctor fees -->
        <label for="display_payment">Doctor Fees:</label>
