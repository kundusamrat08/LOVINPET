...
if (isset($_SESSION['email'])) {
    ...
    if ($result_user && mysqli_num_rows($result_user) == 1) {
        ...
        $sql_cart = "SELECT * FROM cart WHERE user_id='$user_id' ORDER BY id DESC";
        ...
        if ($result_cart && mysqli_num_rows($result_cart) > 0) {
            ...
            <body>
                ...
                ?>
                <div class="container">
                    <h2 class="mt-5 mb-4">Products in Your Cart:</h2>
...
?>
            ...
            echo "<div style='text-align: center;'><p><br><br><br><br><h1>Your Cart is Empty!</h1><br><a href='index.php'>Shop Now!</a><br><br><br><br><br><br></p></div>";
            include('temp/footer.php');
        }
    } else {
    ...
    echo "<div style='text-align: center;'><p><br><br><br><br><h1>Please Login to Access Cart!</h1><br><a href='login.php'>Login Now!</a><br><br><br><br><br><br></p></div>";
