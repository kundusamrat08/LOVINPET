...
<head>
    ...
    <link rel="stylesheet" href="temp/pet_all_display.css">
...
<div class="container" style="max-width: 1172px;">
        ...
        <div class="filter-container">
            ...
            <label for="category">Pet:</label>
                ...
                <select id="breed" name="breed">
                    ...
                    <option class="cates" value="Siamese">Siamese</option>
                    <option class="cates" value="Maine Coon">Maine Coon</option>
                    <option class="cates" value="Persian">Persian</option>
                    <option class="cates" value="Bengal">Bengal</option>
                    <option class="cates" value="Dutch">Dutch</option>
                    <option class="cates" value="Lionhead">Lionhead</option>
                    <option class="cates" value="Mini Lop">Mini Lop</option>
                    <option class="cates" value="Holland Lop">Holland Lop</option>
                    <option class="cates" value="Parrot">Parrot</option>
                    <option class="cates" value="Canary">Canary</option>
                    <option class="cates" value="Cockatiel">Cockatiel</option>
                    <option class="cates" value="Finch">Finch</option>
                    <option class="cates" value="Goldfish">Goldfish</option>
                    <option class="cates" value="Betta">Betta</option>
                    <option class="cates" value="Guppy">Guppy</option>
                    <option class="cates" value="Angelfish">Angelfish</option>
                    <!-- <option class="cates" value="Rabbit">Rabbit</option> -->
                </select>
                <br><br>
                ...
                <select id="age" name="age">
                    ...
                    <option class="cates" value="Kitten">Kitten</option>
                    <option class="cates" value="Bunny">Bunny</option>
                    <option class="cates" value="Hatchling">Hatchling</option>
                    <option class="cates" value="Young Adulthood">Young Adulthood</option>
                    <option class="cates" value="Junior">Junior</option>
                    <option class="cates" value="Juvenile">Juvenile</option>
                    <option class="cates" value="Adulthood">Adulthood</option>
                    <option class="cates" value="Prime">Prime</option>
                    <option class="cates" value="Mature">Mature</option>
    ...
    $conn = mysqli_connect("localhost", "root", "", "pet_adoption");
    // Base SQL query
    $sql = "SELECT * FROM pets WHERE status='Activate'";
