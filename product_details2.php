...
if (isset($_SESSION['email'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        $user_email = $user['email']; // Assuming 'username' is a column in your 'users' table
...
if (isset($_POST['buy_now'])) {
    ...
    $sql_insert_cart = "INSERT INTO cart (user_id, user_name, product_id, product_category, product_name, image, acc_type, stock, price, User_Type, email,quantity,buy_now) VALUES ('$user_id', '$username', '$product_id', 'Accessories', '$product_name', '$product_image', '$product_type', '$product_stock', '$product_price', '$usertype', '$user_email', 1,'bn')";
...
if(isset($_GET['id'])) {
    ...
    $product_id = $_GET['id'];
    $sql = "SELECT * FROM accessories WHERE id = $product_id ";
    ...
    if ($result->num_rows > 0) {
        ...
        $product_cate = $row['acc_category'];
        $product_type = $row['acc_type'];

        $product_description = $row['about_accessories'];
            ...
            <div class="product-div-right">
                ...
                <div class="btn-groups">
                    <form method="post" action="">
                        ...
                        <input type="hidden" name="type" value="<?php echo $row['acc_type']; ?>">
...
<div class="related-products">
    ...
    <div class="product-row">
        ...
        $sql_related = "SELECT * FROM accessories WHERE id != $product_id AND status = 'Activate' ORDER BY RAND() LIMIT 4";
        ...
        if ($result_related->num_rows > 0) {
            while ($row_related = $result_related->fetch_assoc()) {
                ...
                echo "<a class='id-txt' href='product_details2.php?id=" . $row_related['id'] . "'>";
                // Display the first image from the related products
                echo "<img src='upload/" . $row_related['image1'] . "' alt='" . $row_related['name'] . "'>";
                echo "<h3 class='name-txt'>" . $row_related['name'] . "</h3>";
                echo "<p class='price-txt'>₹" . $row_related['price'] . "</p>";
                echo "</div>";
            }
        } else {
