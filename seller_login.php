...
$sql = "SELECT * FROM seller_list where seller_email='" . $email . "' and seller_password='" . $password . "'";
...
<body>
    ...
    <div class="container">
    <div class="heading">Seller Login</div>
    <form action="" class="form"  method="post">
      <input class="input" type="email" name="email" id="email" placeholder="Email" required>
      <input class="input" type="password" name="password" id="password" placeholder="Password" required>

      <input class="login-button" type="submit" name="submit" value="Login">
      <span class="forgot-password">Don't have an account? <a href="seller_registration.php">Register</a></span>
    </form>   
    </div>
</body>
</html>
